...
To enable optional meeting summaries, also configure `OPENROUTER_API_KEY`. You may override `OPENROUTER_MODEL`, `OPENROUTER_TIMEOUT_MS`, `OPENROUTER_MAX_TOKENS`, and `OPENROUTER_TEMPERATURE` if needed.
